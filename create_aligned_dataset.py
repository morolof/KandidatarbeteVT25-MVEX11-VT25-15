...
df = pd.read_csv("C:/Users/tomas/PycharmProjects/pythonProject/Kandidatarbete/csv_and_json/stations_60plusyears_nogaps.csv")
...
# Save to CSV
df_aligned.to_csv("csv_and_json/aligned_stations_60plusyears_nogaps.csv", index=False)
